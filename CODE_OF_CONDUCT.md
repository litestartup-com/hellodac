...
threatening, offensive, or harmful. Maintainers have the right to remove, edit, or reject
...
maintainers through the repository's *Security* → *Report a vulnerability* form (it is the only
private channel the project has) or by contacting a maintainer directly. All complaints will be
reviewed and investigated promptly and fairly, and the privacy and security of the reporter will
be respected.

## Enforcement guidelines

1. **Correction** — a private, written warning explaining the violation, and why the behaviour was
   inappropriate. A public apology may be requested.
2. **Warning** — a warning with consequences for continued behaviour, including no interaction
